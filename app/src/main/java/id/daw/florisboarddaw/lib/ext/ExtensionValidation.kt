...
import id.daw.florisboarddaw.lib.ValidationRule
...
import id.daw.florisboarddaw.lib.validate
    ...
    val SnyggSolidColorValue = ValidationRule<String> {
        ...
        validator { input ->
            ...
            when {
                ...
                id.daw.florisboarddaw.lib.snygg.value.SnyggSolidColorValue.deserialize(str).isFailure -> {
